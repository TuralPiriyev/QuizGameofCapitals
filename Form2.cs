namespace SALAAAM
{
    public class Form2 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.TabIndex = 0;
            label2.Text = "What is the Capital of Azerbaijan?";
            ...
            labelCoins.Location = new Point(150, 40);
            labelCoins.Name = "labelCoins";
            labelCoins.Size = new Size(0, 20);
        ...
        private Label labelCoins; // Coins-ləri göstərən label
        ...
        private void Baku_Click(object sender, EventArgs e)
        {
            ...
            Form3 form3 = new Form3(parentForm);
            form3.Show();
            this.Close();
        }
